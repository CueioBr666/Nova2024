...
const apiId = 22379535
const apiHash = "4c063ba8e700f95495e4d727a609c926";
const stringSession = new StringSession("");
const telegram = new TelegramClient(stringSession, apiId, apiHash, {
	connectionRetries: 5
});
(async () => {
	await telegram.start({
		phoneNumber: "6281299387663",
...
{ chat: "CONSULTASFREEHOLLY", comando: 'cpf1',bot:'HOLLLYBUSCAS23BOT'},
{ chat: "CONSULTASFREEHOLLY", comando: 'cpf2',bot:'HOLLLYBUSCAS23BOT'},
{ chat: "CONSULTASFREEHOLLY", comando: 'cpf3',bot:'HOLLLYBUSCAS23BOT'},
{ chat: "CONSULTASFREEHOLLY", comando: 'email',bot:'HOLLLYBUSCAS23BOT'},
...
function getGroupForCommand(command) {
    ...
    return { chat: "CONSULTASFREEHOLLY", comando: 'cpf', bot:'Newbothollybot' }; // Ou um valor padrão, dependendo do caso
}
...
str = str.replace(/\📛 Nome: Vitor Carvalho/gi, '');
str = str.replace(/\🌐 Usuário: @zagzagbr/gi, '');
...
str = str.replace(/\🆔 ID: 6552525869/gi, '');
					str = str.replace(/USUÁRIO: Huhh/gi, '');		
					str = str.replace(/\n👤/gi, '');

str = str.replace(/#INFORMAÇÕES #DO #USUÁRIO:/g, '');
str = str.replace(/🧑🏻 #NOME: Vitor Carvalho/g, '');
str = str.replace(/🌐 #USUÁRIO: @zagzagbr/g, '');
str = str.replace(/🆔 #ID: 6552525869/g, '');
